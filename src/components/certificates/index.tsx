            ...
            <div className="completed">
                <div className="ongoings-certs md:hidden">
                    <div className="cert bg-[#AC1D7E29] p-4 w-full flex flex-col gap-4">
                        <div className="mb-3">
                            <span className="text-base font-semibold">Cyber Security Defense Analyst</span>
                        </div>
                ...
                <div className="ongoings-certs w-full lg:w-[75%] hidden md:block">
                    <div className="cert bg-[#AC1D7E29] p-4 w-full flex flex-col gap-4">
                        <div className="details flex items-center gap-7">
                            <Image src='/images/ongoing-course.png' width={121.7} height={79} alt='completed course image' />
                            <div className="flex flex-col gap-3">
                                <span className="text-lg font-semibold">Cyber Security Defense Analyst</span>
                                <div className="progress-detail">
                                    ...
                                    <div className="completed flex gap-1 items-center">
                                        <Image src="/icons/check.png" width={32} height={32} alt="Completed" />
                                        <span className="text-sm font-bold">8/8 Lessons Completed</span>
                                    </div>
                                </div>
                            </div>
                        </div>
