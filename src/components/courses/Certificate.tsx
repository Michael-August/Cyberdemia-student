        ...
        <div className="certificate-bg flex flex-col justify-center md:justify-between items-center py-7 gap-2  pb-10 ">
          <div className="flex flex-col items-center gap-1 md:gap-2">
            ...
            <div className="flex flex-col gap-0 items-center">
              <h1
                ...
                style={{ fontWeight: 1000 }}
              >
                {certificateDetails?.issuedCert?.studentId?.fullName}
              </h1>
          ...
          <div className="flex gap-5 md:gap-20 items-center ">
            <div className="flex flex-col gap-1 items-center">
              ...
              <div className="flex flex-col gap-[2px] items-center">
                <span className="text-[8px]">
                  {certificateDetails?.issuedCert?.id}
                </span>
            ...
            <div className="flex flex-col gap-1 items-center">
              ...
              <div className="flex flex-col gap-[2px] items-center">
                <span className="text-[8px]">
                  {moment(certificateDetails?.issuedCert?.issuedDate).format(
                    'DD/MM/yyyy',
                  )}
                </span>
                <span className="text-[8px] text-cp-secondary">
            ...
            <div className="flex flex-col gap-1 items-center">
              <Image
                src={certificateDetails?.issuedCert?.certId?.signature}
                alt="Certificate Background"
                width={40}
                height={300}
              />
