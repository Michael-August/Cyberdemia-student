    ...
    <main className="md:px-20 md:mt-20 overflow-x-clip">
      <div className="banner w-full flex flex-col-reverse md:flex-row gap-10">
        <div className="desc">
          <div className="intro md:mb-5">
            <span className="text-5xl font-semibold leading-[67px]">
              Get Technical Training on{' '}
            </span>
            <span className="text-5xl font-semibold leading-[67px] text-cp-secondary">
              Cyber Security
            </span>
          </div>

          <span className="text-lg font-normal leading-[25px] text-[#000000CC]">
          ...
          <div className="buttons flex gap-5 items-center mt-12">
            ...
            <button className="courses px-[30px] py-5 text-base font-bold border border-solid border-cp-secondary text-cp-secondary">
              See Courses
            </button>
          </div>
      ...
      <div className="why-us mt-32">
        ...
        <div className="paragraph">
          <div className="first mb-7">
            <span className="text-lg text-[#000000CC] leading-[25.2px]">
          ...
          <div className="second mb-7">
            <span className="text-[#000000B2] leading-25.2px] text-lg">
        ...
        <div className="values-list flex items-center justify-center gap-6">
          <div className="value">
            ...
            <div className="value-title mb-4">
              <span className="text-[22px] font-semibold leading-[30.8px] text-[#000000CC]">
                Awareness & Training
              </span>
            </div>
            <div className="details">
              <span className="text-[#000000B2] text-lg leading-[25.2px]">
      ...
      <div className="trainings mt-32">
        ...
        <div className="details mb-8">
          <div className="heading mb-4">
            <span className="text-[20px] text-cp-secondary font-medium leading-[28px]">
              Workforce to secure your critical systems and assets
            </span>
          </div>
          <div className="paragraph">
            <span className="text-lg text-[#000000B2] leading-[25px]">
